...
/**
 * The file that defines the output view data with different format (type2) class for the Spruce Beer Dashboard Plugin
 *
 *
 * @since 		1.0.0
 *
...
class Dashboard_View2 {
    ...
    public static function build_header($brewery, &$out) {
        ...
        $out .= '<div class="dashboard-header-2">';    
